...
export interface CometRewardsInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "claim"
      | "claimTo"
...
export namespace RewardsClaimedSetEvent {
  export type InputTuple = [
    user: AddressLike,
    comet: AddressLike,
    amount: BigNumberish
  ];
  export type OutputTuple = [user: string, comet: string, amount: bigint];
  export interface OutputObject {
    user: string;
    comet: string;
    amount: bigint;
...
export interface CometRewards extends BaseContract {
  connect(runner?: ContractRunner | null): CometRewards;
  ...
  setRewardConfigWithMultiplier: TypedContractMethod<
    [comet: AddressLike, token: AddressLike, multiplier: BigNumberish],
    [void],
    "nonpayable"
  >;

  setRewardsClaimed: TypedContractMethod<
    [comet: AddressLike, users: AddressLike[], claimedAmounts: BigNumberish[]],
    [void],
    "nonpayable"
  >;
  ...
  >;
  getFunction(
    nameOrSignature: "setRewardConfigWithMultiplier"
  ): TypedContractMethod<
    [comet: AddressLike, token: AddressLike, multiplier: BigNumberish],
    [void],
    "nonpayable"
  >;
  getFunction(
    nameOrSignature: "setRewardsClaimed"
  ): TypedContractMethod<
    [comet: AddressLike, users: AddressLike[], claimedAmounts: BigNumberish[]],
    [void],
    "nonpayable"
  ...
  >;
  getEvent(
    key: "RewardsClaimedSet"
  ): TypedContractEvent<
    RewardsClaimedSetEvent.InputTuple,
    RewardsClaimedSetEvent.OutputTuple,
    RewardsClaimedSetEvent.OutputObject
  >;
  ...
  filters: {
    ...
    "RewardsClaimedSet(address,address,uint256)": TypedContractEvent<
      RewardsClaimedSetEvent.InputTuple,
      RewardsClaimedSetEvent.OutputTuple,
      RewardsClaimedSetEvent.OutputObject
    >;
    RewardsClaimedSet: TypedContractEvent<
      RewardsClaimedSetEvent.InputTuple,
      RewardsClaimedSetEvent.OutputTuple,
      RewardsClaimedSetEvent.OutputObject
    >;
