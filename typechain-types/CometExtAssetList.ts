...
export interface CometExtAssetListInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allow"
      | "allowBySig"
...
export interface CometExtAssetList extends BaseContract {
  connect(runner?: ContractRunner | null): CometExtAssetList;
  waitForDeployment(): Promise<this>;

  interface: CometExtAssetListInterface;
