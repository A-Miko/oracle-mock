...
export interface CometWithExtendedAssetListInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "absorb"
      | "accrueAccount"
...
export interface CometWithExtendedAssetList extends BaseContract {
  connect(runner?: ContractRunner | null): CometWithExtendedAssetList;
  waitForDeployment(): Promise<this>;

  interface: CometWithExtendedAssetListInterface;
  ...
  assetList: TypedContractMethod<[], [string], "view">;
