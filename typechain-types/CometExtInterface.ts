...
export interface CometExtInterfaceInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allow"
      | "allowBySig"
...
export interface CometExtInterface extends BaseContract {
  connect(runner?: ContractRunner | null): CometExtInterface;
  waitForDeployment(): Promise<this>;

  interface: CometExtInterfaceInterface;
