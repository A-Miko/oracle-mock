...
export interface MockFeedDec8Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "decimals"
      | "latestAnswer"
...
export interface MockFeedDec8 extends BaseContract {
  connect(runner?: ContractRunner | null): MockFeedDec8;
  waitForDeployment(): Promise<this>;

  interface: MockFeedDec8Interface;
