...
export class CometInterface__factory {
  static readonly abi = _abi;
  static createInterface(): CometInterfaceInterface {
    return new Interface(_abi) as CometInterfaceInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): CometInterface {
    return new Contract(address, _abi, runner) as unknown as CometInterface;
  }
}
