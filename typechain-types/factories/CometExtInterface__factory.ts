...
import type {
  CometExtInterface,
  CometExtInterfaceInterface,
} from "../CometExtInterface";
...
export class CometExtInterface__factory {
  static readonly abi = _abi;
  static createInterface(): CometExtInterfaceInterface {
    return new Interface(_abi) as CometExtInterfaceInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): CometExtInterface {
    return new Contract(address, _abi, runner) as unknown as CometExtInterface;
  }
}
