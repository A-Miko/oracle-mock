...
} from "../../CometMainInterface copy.sol/CometMainInterface";
...
export class CometMainInterface__factory {
  ...
  static createInterface(): CometMainInterfaceInterface {
    return new Interface(_abi) as CometMainInterfaceInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): CometMainInterface {
    return new Contract(address, _abi, runner) as unknown as CometMainInterface;
  }
}
