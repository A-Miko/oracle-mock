...
export interface CometProxyAdminInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "changeProxyAdmin"
      | "deployAndUpgradeTo"
  ...
  encodeFunctionData(
    functionFragment: "deployAndUpgradeTo",
    values: [AddressLike, AddressLike]
  ): string;
  encodeFunctionData(
    functionFragment: "deployUpgradeToAndCall",
...
export interface CometProxyAdmin extends BaseContract {
  connect(runner?: ContractRunner | null): CometProxyAdmin;
  waitForDeployment(): Promise<this>;

  interface: CometProxyAdminInterface;
  ...
  deployAndUpgradeTo: TypedContractMethod<
    [configuratorProxy: AddressLike, cometProxy: AddressLike],
    [void],
    "nonpayable"
  >;

  deployUpgradeToAndCall: TypedContractMethod<
    [configuratorProxy: AddressLike, cometProxy: AddressLike, data: BytesLike],
    [void],
    "nonpayable"
  >;
  ...
  >;
  getFunction(
    nameOrSignature: "deployAndUpgradeTo"
  ): TypedContractMethod<
    [configuratorProxy: AddressLike, cometProxy: AddressLike],
    [void],
    "nonpayable"
  >;
  getFunction(
    nameOrSignature: "deployUpgradeToAndCall"
  ): TypedContractMethod<
    [configuratorProxy: AddressLike, cometProxy: AddressLike, data: BytesLike],
    [void],
    "nonpayable"
