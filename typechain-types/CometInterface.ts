...
export interface CometInterfaceInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "absorb"
      | "accrueAccount"
...
export interface CometInterface extends BaseContract {
  connect(runner?: ContractRunner | null): CometInterface;
  waitForDeployment(): Promise<this>;

  interface: CometInterfaceInterface;
