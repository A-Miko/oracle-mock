...
export interface CometFactoryWithExtendedAssetListInterface extends Interface {
...
export interface CometFactoryWithExtendedAssetList extends BaseContract {
  connect(runner?: ContractRunner | null): CometFactoryWithExtendedAssetList;
  waitForDeployment(): Promise<this>;

  interface: CometFactoryWithExtendedAssetListInterface;
