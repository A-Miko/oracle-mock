...
export interface CometCoreInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "hasPermission"
      | "isAllowed"
...
export interface CometCore extends BaseContract {
  connect(runner?: ContractRunner | null): CometCore;
  waitForDeployment(): Promise<this>;

  interface: CometCoreInterface;
